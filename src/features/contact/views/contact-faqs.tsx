	...
	return (
		<Faq>
			...
			<FaqContent title="What technologies do you use for website development?">
				...
				type-safe APIs (tRPC, Hono), state management (TanStack Query, Zustand),
				databases (Prisma, Drizzle ORM), testing (Vitest, Playwright), and
				modern build tools (Turbopack, Vite). We also leverage GSAP for
				animations, React Hook Form for forms, and MDX for content management.
			</FaqContent>
			...
			<FaqContent title="Will my website be mobile-responsive?">
				...
				responsive, ensuring excellent experiences across all devices — desktop,
				tablet, and mobile. We test on multiple devices and screen sizes.
			</FaqContent>
			<FaqContent title="Do you handle SEO optimization?">
				Yes. SEO best practices are integrated throughout development, including
				semantic HTML, meta tags, structured data, fast performance, and
				SEO-friendly architecture. We can also provide ongoing SEO services.
			</FaqContent>
			...
			<FaqContent title="Do you build e-commerce websites?">
				Yes. We build complete e-commerce solutions with shopping carts, payment
				processing, product management, inventory systems, and order
			...
			<FaqContent title="Can you redesign an existing website?">
				...
				design, performance, and user experience while maintaining SEO value and
			...
			<FaqContent title="Do you use type-safe APIs and databases?">
				...
				safety, Prisma or Drizzle ORM for type-safe database access, and ensure
				full TypeScript inference throughout the entire stack for better
				developer experience and fewer runtime errors.
			</FaqContent>
			<FaqContent title="What testing frameworks do you use?">
				We use Vitest for fast unit testing, Playwright for end-to-end testing,
				and Testing Library for component testing. All testing is done with full
				TypeScript support for type-safe test suites.
			</FaqContent>
		</Faq>
	);
};
