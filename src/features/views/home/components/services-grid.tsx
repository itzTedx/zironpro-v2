...
export const WebDevelopmentGrid = ({ className }: { className?: string }) => {
	return (
		...
		>
			...
			<Image
				alt="Web development service interface by Ziron pro"
			...
			<div className="absolute bottom-12 left-0 z-10 w-full md:bottom-30">
				<div className="mask-x-from-80%">
					<Marquee className="[--duration:20s]" repeat={10}>
						<Image
							alt="Brand pattern block by Ziron pro"
						...
						/>
						<Image
							alt="Typography sample block by Ziron pro"
							className="pointer-events-none size-20 md:size-26"
							height={150}
						...
						/>
						<Image
							alt="Logo sample block by Ziron pro"
							className="pointer-events-none size-20 md:size-26"
							height={150}
						...
						/>
						<Image
							alt="Logo variation sample by Ziron pro"
							className="pointer-events-none size-20 md:size-26"
							height={150}
	...
	return (
		...
		>
			...
			<div className="pointer-events-none inset-y-0 -right-8 z-10 -mb-6 select-none md:absolute md:h-full md:w-2/3">
				<Image
					alt="Motion software interface by Ziron pro"
...
export function Notification({ notification }: NotificationProps) {
	return (
		<div className="flex w-full max-w-[290px] items-center justify-between gap-4 rounded-2xl border border-dashed bg-gray-1200 p-3.5 shadow-xl">
			<Image
				alt={`${notification.name} notification icon by Ziron pro`}
				className="h-10 w-10"
				height={40}
				loader={({ src }) => src}
